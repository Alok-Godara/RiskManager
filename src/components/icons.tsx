// Small, dependency-free stroke icon set used by the sidebar nav and headers.
// Kept as plain inline SVG (no icon library) to avoid adding a dependency
// for ~6 glyphs.
...
export function IconLayers({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="m2.5 13 9.5 5.5L21.5 13" />
      <path d="m2.5 18 9.5 5.5L21.5 18" />
    </svg>
  );
}

export function IconStructure({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function IconCloud({ size = 14 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M7 18h10.5a3.5 3.5 0 0 0 .5-6.96 5 5 0 0 0-9.71-1.7A4.5 4.5 0 0 0 7 18Z" />
    </svg>
  );
}

export function IconDisk({ size = 14 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
