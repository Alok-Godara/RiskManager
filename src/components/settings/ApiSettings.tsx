      ...
      <div className="card-grid">
        <div className="stat-card">
          ...
          <div className="stat-sub">
            {isQuantHub
              ? "QuantHub 1-minute OHLC, polled ~every 1.3s (50 req/min budget) for contracts in open positions — pauses automatically if the token gets rate-limited, then resumes"
